...
func (c *sessionServiceClient) DeleteSessionsByUsers(ctx context.Context, in *DeleteSessionsByUsersRequest, opts ...grpc.CallOption) (*DeleteSessionsByUsersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteSessionsByUsersResponse)
	err := c.cc.Invoke(ctx, SessionService_DeleteSessionsByUsers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SessionService_DeleteSessionsByUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteSessionsByUsersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SessionServiceServer).DeleteSessionsByUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SessionService_DeleteSessionsByUsers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionServiceServer).DeleteSessionsByUsers(ctx, req.(*DeleteSessionsByUsersRequest))
	}
...
var SessionService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/session_service/proto/session.proto",
}
